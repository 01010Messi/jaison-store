              ...
              {revenueByDay.map((day) => {
                ...
                return (
                  <div key={day.date} className="flex-1 flex flex-col items-center gap-1">
                    <span className="text-[10px] font-accent text-bark/72">
                    ...
                    <span className="text-[10px] font-accent text-bark/72 uppercase">
                      {dayLabel}
                    </span>
              ...
              {topProducts.map((product, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-bark/72 font-body">
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={cn(
                        ...
                        statusColors[order.status] || "text-bark/72"
                      )}
                    >
                      {order.status}
                    </p>
          ...
          {lowStockDetails.length > 0 && (
            <div className="mt-4 pt-4 border-t border-border/30">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-xs font-accent uppercase tracking-wider text-bark/72">
