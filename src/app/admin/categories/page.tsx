      ...
      {categories.length === 0 ? (
        ...
        <div className="bg-cream rounded-sm border border-border/50 overflow-hidden">
          ...
          <div className="grid grid-cols-[1fr_1fr_auto_auto] gap-4 px-4 py-3 bg-parchment/30 border-b border-border/50">
            ...
            <p className="text-xs font-accent uppercase tracking-wider text-bark/40 text-center w-24">
              Products
            </p>
            <p className="text-xs font-accent uppercase tracking-wider text-bark/40 text-center w-20">
              Order
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-9 h-9 bg-parchment/50 rounded-full flex items-center justify-center shrink-0">
                    <Layers className="h-4 w-4 text-bark/50" />
                  </div>
                ...
                <p className="text-xs text-bark/50 font-body font-mono truncate">
                  {category.slug}
                </p>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 bg-cream border border-border rounded-sm font-body text-bark text-sm placeholder:text-bark/40 transition-all duration-200 hover:border-gold/60 focus:border-gold focus:ring-1 focus:ring-gold/30 focus:outline-none resize-none"
            />
          </div>
          <Input
            label="Sort Order"
