    ...
    <>
      <style>{`
        .our-story-btn-primary:hover {
          box-shadow: 0 0 28px rgba(253, 250, 245, 0.35);
        }
        .our-story-btn-primary:active {
          box-shadow: 0 0 40px rgba(253, 250, 245, 0.5);
          transform: scale(0.98);
        }
        .our-story-btn-outline:hover {
          box-shadow: 0 0 20px rgba(253, 250, 245, 0.18);
          background-color: rgba(253, 250, 245, 0.06);
        }
        .our-story-btn-outline:active {
          box-shadow: 0 0 32px rgba(253, 250, 245, 0.28);
          transform: scale(0.98);
        }
      `}</style>
      ...
      <div className="min-h-screen" style={{ backgroundColor: "#FDFAF5" }}>
        ...
        >
          ...
          >
            <span style={{ color: "#FDFAF5" }}>The next 55 years </span>
          ...
          <p
            ...
            style={{ color: "rgba(253,250,245,0.48)", maxWidth: "460px" }}
          >
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              ...
              style={{ borderColor: "rgba(253,250,245,0.32)", color: "#FDFAF5" }}
            >
              READ: WHY POWDER?
            </Link>
          </div>
