...
const questions = [
  {
    ...
    options: [
      ...
      { value: "dull",      label: "Dull or uneven tone",     recommended: false, bg: "#F7F2E4", dot: "#BCA480" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "dry_t",   label: "Dry",         recommended: false, bg: "#F7F2E4", dot: "#BCA480" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "twice", label: "Twice a week",    recommended: true,  bg: "#F7F2E4", dot: "#BCA480" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "milk",   label: "Raw milk",    recommended: false, bg: "#F7F2E4", dot: "#BCA480" },
...
const recs: Record<string, Rec> = {
  oily: {
    ...
    primary:   { name: "Multani Mitti",      slug: "multani-mitti",      category: "SKIN CARE", latin: "Fuller's Earth Clay",    price: 245,             badge: "DEEP CLEAN",    image: "/images/products/multani-mitti.jpg", dot: "#C16B4A", bg: "#F5EDE8" },
    secondary: { name: "Neem Powder",        slug: "neem-powder",        category: "SKIN CARE", latin: "Azadirachta indica",      price: 195,             badge: "ANTIBACTERIAL", image: "/images/products/neem.jpg",          dot: "#4A7C59", bg: "#EDF2EC" },
  },
  dull: {
    heading: "Two powders.",
    italic: "Twice a week.",
    subtext: "Based on your answers, we'd start you on these two. Use them on alternate days. Reassess in four weeks.",
    primary:   { name: "Ubtan Powder",       slug: "ubtan-powder",       category: "SKIN CARE", latin: "Curcuma longa + 7 herbs", price: 440, compareAt: 565, badge: "22% OFF",   image: "/images/products/ubtan.jpg",         dot: "#BCA480", bg: "#F7F2E4" },
    secondary: { name: "Orange Peel Powder", slug: "orange-peel-powder", category: "SKIN CARE", latin: "Citrus sinensis peel",    price: 245,             badge: "VITAMIN C",     image: "/images/products/orange-peel.jpg",   dot: "#D4784A", bg: "#FEF0E8" },
  },
  sensitive: {
    heading: "Two gentle powders.",
    italic: "Start slow.",
    subtext: "These are the gentlest powders in the range. Begin once a week and listen to your skin.",
    primary:   { name: "Rose Petal Powder",  slug: "rose-petal-powder",  category: "SKIN CARE", latin: "Rosa damascena",          price: 295,             badge: "SOOTHING",      image: "/images/products/rose-petal.jpg",    dot: "#D4748C", bg: "#F5ECF0" },
    secondary: { name: "Neem Powder",        slug: "neem-powder",        category: "SKIN CARE", latin: "Azadirachta indica",      price: 195,             badge: "GENTLE",        image: "/images/products/neem.jpg",          dot: "#4A7C59", bg: "#EDF2EC" },
  },
  hair: {
    heading: "Two powders.",
    italic: "For stronger hair.",
    subtext: "Based on your answers, we'd start you on these two. Use them on alternate days. Reassess in four weeks.",
    primary:   { name: "Amla Powder",        slug: "aamla-powder",       category: "HAIR CARE", latin: "Phyllanthus emblica",     price: 195,             badge: "STRENGTHENING", image: "/images/products/amla.jpg",          dot: "#4A7C59", bg: "#EDF2EC" },
    secondary: { name: "Bhringraj Powder",   slug: "bhringraj-powder",   category: "HAIR CARE", latin: "Eclipta prostrata",       price: 245,             badge: "GROWTH",        image: "/images/products/bhringraj.jpg",     dot: "#2D6B4A", bg: "#E8F0EC" },
  },
};
        ...
        {step === 5 && (
          <>
            ...
            <div className="text-center mb-10">
              <h2 className="font-heading text-[2.75rem] md:text-[4rem] font-light leading-[1.05] tracking-[-0.02em] text-bark">
                {rec.heading}{" "}
                <span style={{ color: "#A0885C", fontStyle: "italic" }}>
                  {rec.italic}
                </span>
              </h2>
              <p
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <Link
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 20px rgba(160,136,92,0.45)"; }}
