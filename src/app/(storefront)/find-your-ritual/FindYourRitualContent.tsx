...
const recs: Record<string, Rec> = {
  ...
  dull: {
    ...
    italic: "Twice a week.",
    subtext: "Based on your answers, we'd start you on these two. Use them on alternate days. Reassess in four weeks.",
    primary:   { name: "Ubtan Powder",       slug: "ubtan-powder",       category: "SKIN CARE", latin: "Curcuma longa + 7 herbs", price: 440, compareAt: 565, badge: "22% OFF",   image: "/images/products/ubtan.jpg",         dot: "#E26713", bg: "#F7F2E4" },
