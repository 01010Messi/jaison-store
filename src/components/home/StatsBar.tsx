...
export default function StatsBar() {
  return (
    <section className="bg-cream">
      ...
      <div className="grid grid-cols-3 gap-4 md:gap-16 max-w-5xl mx-auto text-center px-6 md:px-16 py-10 md:py-14">
        {stats.map((stat) => (
          <div key={stat.number} className="flex flex-col items-center gap-2">
            <span className={`font-heading text-5xl md:text-9xl leading-none ${stat.colour}`}>
              {stat.number}
            </span>
